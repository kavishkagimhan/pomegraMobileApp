...
const Soiltemperature = () => {
  ...
  return (
    ...
    >
      <Text className="p-4 text-2xl font-semibold">Soil Temperature</Text>
      <Text className="text-xl font-semibold">Temperature: {temperatureLevel}%</Text>
      <Slider
        ...
        onValueChange={(value) => setTemperatureLevel(value)}
      />
      <View className="mt-8">
